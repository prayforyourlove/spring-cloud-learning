...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="/zc-hotel-web/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="/zc-hotel-web/css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:888">
    		<img src="/zc-hotel-web/images/taotao-logo.gif" alt="淘淘商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span>我已经注册，现在就&nbsp;
        	<a href="http://localhost:888/zc-hotel-web/login" class="flk13">登录</a>
        </span>
        </div>
    </div>
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="phone" maxlength="11" name="mobile"
            ...
            <div class="phone">
                <img width="180" height="180" src="/zc-hotel-web/images/phone-bg.jpg"/>
            </div>
            <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript">
	var REGISTER={
		...
		doSubmit:function() {
			$.post("/zc-hotel-web/user/register",$("#personRegForm").serialize(), function(data){
				if(data.status == 200){
					alert('用户注册成功，请登录！');
					REGISTER.login();
				} else {
		...
		login:function() {
			 location.href = "/zc-hotel-web/login";
			 return false;
		},
		reg:function() {
			if (this.inputcheck()) {
