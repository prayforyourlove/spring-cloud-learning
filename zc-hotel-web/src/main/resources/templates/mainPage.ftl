...
<div class="mainPage">
    ...
    <div class="container">
        ...
        <div class="box-left">
            <h2 class="white-text">浙江三洋宾馆欢迎您</h2>
            <p>您满意的微笑，是我们最大的动力</p>
            ...
            <div >
                ...
                <p>三洋宾馆为您提供各种特色精品服务，种类有：会议宴请、按摩理疗、旅游介绍、租车服务、特产代购、儿童天地</p>
        ...
        <div class="box-right">
            <h2 class="white-text">浙江三洋宾馆</h2>
            <p>三洋集团旗下的中高端品牌酒店，有融合奢华、舒适为一体的套房上白套。拥有设施完善的宴会和会议厅、融汇中西美食精华的餐厅、
            ...
            <div >
                <h3>走近三洋</h3>
                <p>三洋集团旗下的中高端品牌酒店，有融合奢华、舒适为一体的套房上白套。拥有设施完善的宴会和会议厅、融汇中西美食精华的餐厅<a href="">了解更多</a></p>
